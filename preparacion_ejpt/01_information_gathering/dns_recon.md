...
Es un comando para realizar búsquedas DNS, que normalmente convierte dominios a direcciones IP y viceversa. Emjemplo:

``` bash
$ host ejemplo.com
ejemplo.com has address 18.14.196.25
ejemplo.com has address 18.14.197.25
ejemplo.com has IPv6 address 3a16:48b1::31b2:5
ejemplo.com has IPv6 address 3a16:48b1::31b2:5
ejemplo.com mail is handled by 0 _dc-mx.2c2a.ejemplo.com.
ejemplo.com has HTTP service bindings 1 . alpn="h3,h2" ipv4hint=18.14.196.25,18.14.197.25 ech=AEX+DQBBrQAgACCUYEDeccFLe17cu7FbeQwL7p+DEgrqJu8J9ByrvEyvJgAEAAEAAQASY2xvdWRmbGFyZS1lY2guY29tAAA= ipv6hint=3a16:48b1::31b2:5,3a16:48b1::31b1:5
```

A continuación se muestran algunas de las opciones más interesantesen la fase de reconocimiento.
